...
import { addRoomAccommodation, IAddRoomAccommodation } from "@/api/mutations/room-accommodation.mutation";
...
export default function AddRoomAccommodation({ accommodationId }: Props) {
	...
	const { mutate: createMutate, isPending } = useMutation({
		mutationFn: async (data: IAddRoomAccommodation) => await addRoomAccommodation(data),
		onSuccess: (data) => {
